						...
						<div class="col-md-6 col-sm-12 text-right">
							<div class="dropdown">
								...
								<div class="dropdown-menu dropdown-menu-right">
									...
									<a class="dropdown-item active" href="third-party-plugins.php">Third Party Plugins</a>
								</div>
							</div>
						</div>
					</div>
						...
						<table class="data-table table nowrap">
							...
							<tbody>
								...
								<tr>
									...
									<td><a target="_blank" class="text-blue" href="http://ionden.com/a/plugins/ion.rangeSlider/index.php">http://ionden.com/a/plugins/ion.rangeSlider/index.php</a></td>
								</tr>
								<tr>
